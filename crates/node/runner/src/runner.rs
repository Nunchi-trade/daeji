...
impl NodeRunner for ProductionRunner {
    ...
    async fn run(&self, ctx: NodeRunContext<Self::Transport>) -> Result<Self::Handle, Self::Error> {
        ...
        // Rayon worker threads for BLS signature verification.  Two threads
        // provide meaningful parallelism for batch-verifying votes (7-10 per
        // view at N=10) without the oversubscription that higher counts cause
        // under Docker CPU limits.
