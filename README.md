<p align="center">
    <img src="./assets/diver.png" alt="Daeji" width="200">
</p>

<h1 align="center">Daeji</h1>
...
<p align="center">
  <img src="https://img.shields.io/badge/rust-nightly-fbbf24.svg?style=flat&labelColor=1C2C2E&logo=rust&logoColor=white" alt="Rust nightly">
  <a href="https://github.com/Nunchi-trade/daeji/actions/workflows/ci.yml"><img src="https://img.shields.io/github/actions/workflow/status/Nunchi-trade/daeji/ci.yml?style=flat&labelColor=1C2C2E&label=ci&logo=GitHub%20Actions&logoColor=white" alt="CI"></a>
  <a href="https://github.com/Nunchi-trade/daeji/blob/main/LICENSE"><img src="https://img.shields.io/badge/License-MIT-d1d1f6.svg?style=flat&labelColor=1C2C2E&color=a78bfa&logo=googledocs&logoColor=white" alt="License"></a>
</p>

<p align="center">
  <a href="#whats-daeji">What's Daeji?</a> •
...
> [!CAUTION]
> Daeji is pre-alpha software. Do not expect this to run. Do not run this in production.

> [!IMPORTANT]
> Daeji uses BLS12-381 threshold consensus via [commonware](https://github.com/commonwarexyz/monorepo), [REVM](https://github.com/bluealloy/revm) for EVM execution, and [QMDB](https://github.com/commonwarexyz/monorepo/tree/main/storage) for state storage.

> [!IMPORTANT]
> Daeji currently requires the repository's pinned nightly Rust toolchain. The
> workspace metadata records the dependency floor as Rust 1.91+, but stable Rust
> cannot build the workspace while nightly-only features are in use.
