...
export class ConnectionManager {
    ...
    scheduleReconnect() {
        ...
        const baseDelay = Math.min(MAX_RECONNECT_DELAY, INITIAL_RECONNECT_DELAY *
        ...
        console.info(`[ConnectionManager] Reconnect attempt ${this.reconnectAttempt} in ${delay}ms`);
        this.clearReconnectTimer();
