...
describe("truncateAddress", () => {
  ...
  it("supports custom char count", () => {
    expect(
      truncateAddress("0xd8dA6BF26964aF9D7eEd9e03E53415D37aA96045", 6),
    ).toBe("0xd8dA6B...A96045");
  });
...
describe("formatEth", () => {
  ...
  it("supports custom decimal places", () => {
    expect(formatEth(1_500_000_000_000_000_000n, 2)).toBe("1.5");
  });
  ...
  it("formats fractional ETH values", () => {
    expect(formatEth(1_234_567_890_000_000_000n)).toBe("1.2345");
  });
...
describe("formatBlockNumber", () => {
  ...
  it("formats bigint block number", () => {
    expect(formatBlockNumber(19_000_000n)).toBe("19,000,000");
  });
