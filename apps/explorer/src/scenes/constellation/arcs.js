 ...
 */
export function computeArc(from, to, value, txHash, status) {
...
export function bezierPoint(arc, t) {
    const u = 1 - t;
    return {
    ...
    update(dt) {
        ...
        for (let i = this.arcs.length - 1; i >= 0; i--) {
            ...
            if (arc.progress < 1) {
                ...
                const ageAfterTravel = (now - arc.birthTime) / 1000 - ARC_TRAVEL_DURATION;
