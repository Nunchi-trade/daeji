 ...
 *   1500ms+:    nullifying
 */
export function usePollConsensusProvider() {
    ...
    const poll = useCallback(async () => {
        try {
            ...
            if (status.currentView === prev.currentView) {
                ...
                let estimatedPhase;
                if (elapsed < 200)
                    estimatedPhase = 'proposing';
                else if (elapsed < 500)
                    estimatedPhase = 'notarizing';
                else if (elapsed < 800)
                    estimatedPhase = 'certifying';
                else if (elapsed < 1500)
                    estimatedPhase = 'finalizing';
                else
                    estimatedPhase = 'nullifying';
