...
interface FeeWaveformProps {
  /** Width in pixels */
  width?: number;
  /** Height in pixels */
  height?: number;
  /** Stroke color. Defaults to rose. */
  color?: string;
  /** Show axis labels */
  showLabels?: boolean;
}
...
export function FeeWaveform({
  ...
  if (feeHistory.length < 2) {
    return (
      <svg
        ...
        height={height}
        style={{ display: 'block' }}
        aria-label="Fee waveform (no data)"
      >
        <line
          x1={0}
          y1={height / 2}
  ...
  return (
    ...
    >
      ...
      <path d={fillPath} fill="url(#feeGrad)" />
