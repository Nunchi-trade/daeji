...
function dotColor(phase: RoundPhase): string {
  if (phase === 'finalized') return 'var(--rd-success)';
  if (phase === 'nullified') return 'var(--rd-warning)';
  if (
    phase === 'proposing' ||
    phase === 'notarizing' ||
    phase === 'certifying' ||
...
function isActive(phase: RoundPhase): boolean {
  return (
    phase === 'proposing' ||
    phase === 'notarizing' ||
    phase === 'certifying' ||
          ...
          >
            ...
            {dots.map((d) => (
              <circle
                ...
                r={DOT_R}
                fill={d.color}
                className={d.active ? 'rd-dot-active' : undefined}
              />
            ))}
