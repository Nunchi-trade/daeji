...
interface BlockTimeSparklineProps {
  width?: number;
  height?: number;
}

export function BlockTimeSparkline({
  width = 160,
  height = 48,
}: BlockTimeSparklineProps) {
  ...
  return (
    ...
    >
      ...
      <line
        x1={0}
        y1={isEmpty ? height / 2 : refY}
        x2={width}
        y2={isEmpty ? height / 2 : refY}
      ...
      {/* Numeric overlay: average block time */}
      {!isEmpty && avg > 0 && (
        <text
          x={width}
          y={10}
